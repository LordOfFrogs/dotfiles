...
hl.bind(
	...
	{ description = "Swap tiled window down" }
)
...
hl.bind(
	mainMod .. " + SHIFT + B",
	hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-reload-statusbar"),
	{ description = "Reload Status Bar" }
)
hl.bind(
	mainMod .. " + CTRL + B",
	hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-statusbar"),
	{ description = "Toggle Status Bar" }
)
hl.bind(
	mainMod .. " + ALT + D",
	hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-reload-dock"),
	{ description = "Reload Dock" }
)
hl.bind(
	mainMod .. " + CTRL + D",
	hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-dock"),
...
-- hl.bind(
-- 	mainMod .. " + SPACE",
-- 	hl.dsp.exec_cmd("qs ipc call statusbar focus"),
